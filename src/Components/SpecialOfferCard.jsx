  ...
  return (
    <>
      <div className="bg-white p-3 rounded-md relative flex flex-col gap-4">
        ...
        <button className="text-base cpr py-3 px-6 bg-[#EF8C2C] rounded-full cursor-pointer font-semibold absolute bottom-0 right-3 translate-y-1/2 flex items-center gap-1">
